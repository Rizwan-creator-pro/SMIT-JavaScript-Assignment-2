...
document.getElementById("ifStatementsNested").onclick = function () {
    ...
    if (age >= 18) {
        ...
        // check book name
            ...
            if (bookAvailable === "atonement") {
                massage = "The Atonement book is available. You can borrow it."
            } else if (bookAvailable === "annihilation") {
                massage = "The Annihilation book is available. You can borrow it."
            } else {
...
document.getElementById("Login").onclick = function () {
    ...
    if (loginusername !== "" && loginusername !== " " && username === loginusername ) {
        let password = +prompt("Enter password (at least 5 characters):")
        if (password >= 10000) {
